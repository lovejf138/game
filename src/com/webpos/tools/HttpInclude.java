...
public class HttpInclude {
	...
	public String include(String includePath) {
		StringWriter sw = new StringWriter(8192);     //设置缓存字节大小
	...
	/**
	 * 判断是否是 http：//  或者  http：//  开头的网址
	 * @param includePath    要包含的地址
	 * @return
	 */
	...
	private void getLocalContent(String includePath, Writer writer)
		...
		String url_path = includePath.indexOf("?") > 0 ? includePath.substring(  // top.htm
