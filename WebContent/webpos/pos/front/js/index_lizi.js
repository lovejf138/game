window.requestAnimFrame = (function () {
	...
	(function() {
		...
		var	canvas = document.getElementById('room_myCanvas'),
...
setInterval(buttonEffect,1500);

		function buttonEffect() {

			var button = document.getElementById('room_button'),
	...
	//	window.addEventListener('resize', setFullscreen );
		...
		function createParticle( args ) {
			...
			var options = {
				x: width/2,
				y: height/2,
				color: 'hsla('+ Math.randMinMax(10, 50) +', 88%, 50%, '+(Math.random().toFixed(2))+')',
