		...
		<div id="wrap">	
			...
			<nav class="navbox navbox_class2">
				...
				<div class="navContent">
					<div class="navList c" onClick="window.location.href='goods.do?beishu=6'">
			...
			<div class="in-content-box">
				...
				<div class="in-content-title" >
					<div style="text-align:center;padding-top: 10px;">
						...
						规则：根据粤11选5每期开奖结果,从1～11中任选1个或多个号码，所选号码与开奖号码第一位号码相同，即中奖
						</a>
					</div>
...
<div class="footer">
	...
	<div class="foot_r"><a href="javascript:;" class="ljgm">￥${goods.nowprice}抢购</a></div>
		...
		<script src='<%=request.getContextPath()%>/webpos/pos/front/js/goods6_123.js?t=4'></script>
		<script>
var _hmt = _hmt || [];
(function() {
